...
class DMSAuroraMysqlToKinesisStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, vpc, target_kinesis_stream_arn, **kwargs) -> None:
    ...
    sm_client = boto3.client('secretsmanager', region_name=vpc.env.region) #Root Of Cause
